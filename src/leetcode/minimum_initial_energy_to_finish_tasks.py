...
You are given an array tasks where tasks[i] = [actual, minimum]:
  - `actual` is the actual amount of energy you spend to finish the ith task.
  - `minimum` is the minimum amount of energy you require to begin the ith task.
...
class Solution:
  ...
  def minimum_effort(tasks: List[List[int]]) -> int:
    ...
    for actual, minimum in tasks:
      energy = max(energy, minimum - actual) + actual
